...
const PromoBanner = () => {
  return (
      <div className='mt-16 py-12 bg-pink-200 px-4 lg:px-24'>
        <div className='flex flex-col md:flex-row justify-between items-center gap-12 w-full'>
          <div className='md:w-1/2'>
            ...
            <Link to="/shop" className='block'>
              <button className='bg-pink-700 text-white font-semibold px-5 py-2 rounded hover:bg-black transition-all duration-300'>
                Get Promo
              </button>
            </Link>
          </div>
